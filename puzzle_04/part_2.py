...
def test_examples():
    assert validate_sets_of_two('111111') == False
    assert validate_sets_of_two('223450') == True
    assert validate_sets_of_two('123789') == False
    assert validate_sets_of_two('112233') == True
    assert validate_sets_of_two('123444') == False
    assert validate_sets_of_two('111122') == True
    ...
    assert validate_never_decrease('112233') == True
    assert validate_never_decrease('123444') == True
    assert validate_never_decrease('111122') == True
